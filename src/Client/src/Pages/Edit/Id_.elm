...
import Request
import Request.Request exposing (getToDo, saveToDo)
...
init mbSession todoId =
    ...
    , Maybe.map (\c -> getToDo c.origin todoId OnFetchDataComplete) mbSession |> Maybe.withDefault Cmd.none
    )
        ...
        , div
            ...
            , div [ class "row" ]
                [ div [ class "col-md-12 mb-3" ]
                    ...
                    , Html.input [ type_ "datetime-local", HA.name "start", class "form-control" ] []
                    ]
                , div [ class "col-md-6 mb-3" ]
                    [ viewLabel [ text "End" ]
                    , Html.input [ type_ "datetime-local", HA.name "end", class "form-control" ] []
                    ]
                , div [ class "col-md-6 mb-3" ]
            ...
            , div [ class "mb-3" ]
                [ button [ type_ "submit", class "btn btn-primary", onClick OnSave ] [ text "Absenden" ]
                ]
            ]
        ]
